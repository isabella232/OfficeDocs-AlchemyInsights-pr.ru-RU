...
- Чтобы окончательно удалить сайт, ознакомьтесь со статьей [Удаление сайта без возможности восстановления](https://docs.microsoft.com/en-us/sharepoint/delete-site-collection#permanently-delete-a-site). Этот шаг потребуется, если вы планируете повторно использовать URL-адрес. 
- Удаление дочернего сайта в разделе [Удаление сайта или](https://support.office.com/en-us/article/Delete-a-SharePoint-site-or-subsite-bc37b743-0cef-475e-9a8c-8fc4d40179fb#__bkmkshortcut) дочернего сайта куиккстепс
