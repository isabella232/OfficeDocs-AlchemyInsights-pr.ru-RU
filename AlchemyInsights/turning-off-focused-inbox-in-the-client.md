...
Чтобы отключить сортировку почты для всех пользователей в Организации, ознакомьтесь со статьей [Настройка отсортированной папки "отсортированные" для всех пользователей в Организации](https://docs.microsoft.com/office365/admin/setup/configure-focused-inbox).
