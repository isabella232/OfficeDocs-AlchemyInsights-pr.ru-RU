...
ms.locfileid: "28308992"
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Устранение проблем с сертификатом Apple MDM Push-в Microsoft Intune

Просмотрите ресурсы, перечисленные ниже, чтобы устранить проблему сейчас. 
  
1. Просмотрите [Этот документ](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) настройки или обновить Apple MDM push сертификат. 
