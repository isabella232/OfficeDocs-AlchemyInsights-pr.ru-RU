...
---
# <a name="verify-your-domain-with-dreamhost"></a>Проверка домена с помощью Dreamhost
...
Пошаговые инструкции по [созданию записей DNS на сайте Dreamhost для Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-dreamhost) .