...
**Note**: в настоящее время средство миграции SharePoint поддерживает только миграцию с SharePoint 2010 и 2013. В настоящее время версия 2016 не поддерживается.
