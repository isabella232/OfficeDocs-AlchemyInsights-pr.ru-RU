...
- Если у вас менее 25 назначенных лицензий, вы можете отменить подписку в Интернете. Перейдите к разделу **подписки**на [выставление счетов](https://admin.microsoft.com/adminportal/home#/subscriptions) \> , а затем выберите **Дополнительные действия** \> **Отмена подписки**.
...
- Чтобы узнать больше об отмене подписки или пошаговых инструкциях, ознакомьтесь со статьей [Отмена Office 365 для бизнеса](https://support.office.com/article/Cancel-Office-365-for-business-b1bc0bef-4608-4601-813a-cdd9f746709a?wt.mc_id=o365_portal_mmaven&amp;ui=en-US&amp;rs=en-US&amp;ad=US.aspx).
