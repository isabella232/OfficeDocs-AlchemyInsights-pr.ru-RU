...
- Если у вас менее 25 назначенных лицензий, можно отменить подписку через Интернет. Последовательно выберите пункты [выставления счетов](https://support.office.com/article/https://portal.office.com/adminportal/home.aspx#/subscriptions) \> **подписки**и затем выберите **Дополнительные действия** \> **Отменить подписку**.
