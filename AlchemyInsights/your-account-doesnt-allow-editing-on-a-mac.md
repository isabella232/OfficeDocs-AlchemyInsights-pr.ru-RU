...
---
# <a name="fixing-the-office-apps-your-account-doesnt-allow-editing-on-a-mac-message"></a>Устранение неполадок в приложениях Office "Ваша учетная запись не позволяет редактировать сообщение в Mac"
