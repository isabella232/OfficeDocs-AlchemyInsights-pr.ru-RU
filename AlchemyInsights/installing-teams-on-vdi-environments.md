...
ms.locfileid: "47663058"
---
# <a name="installing-teams-on-vdi-environments"></a>Установка Teams в средах VDI

Сведения о развертывании Teams на общих компьютерах, службах удаленных рабочих столов (RDS) или инфраструктуре виртуальных рабочих столов (VDI) можно найти [в разделе Общие среды компьютера и VDI с Microsoft Teams](https://docs.microsoft.com/deployoffice/teams-install#shared-computer-and-vdi-environments-with-microsoft-teams).