...
ms.locfileid: "28307874"
---
# <a name="troubleshoot-issues-with-enrolling-macos-devices-in-microsoft-intune"></a>Устранение неполадок с регистрация macOS устройств в Microsoft Intune
...
3. [Узнайте, как возможность зачисления macOS устройств в Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Руководство по конечных пользователей возможность зачисления macOS устройство в Майкрософт Intune](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
