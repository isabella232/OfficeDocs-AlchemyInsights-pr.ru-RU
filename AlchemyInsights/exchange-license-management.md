...
- Для **покупки** Exchange перейдите в раздел **Оплата > [Услуги покупки](https://go.microsoft.com/fwlink/p/?linkid=868433)**. Используйте поле поиска для поиска по «Exchange»; выберите план и количество пользователей. Дополнительные сведения см. в статье [Приобретение подписки](https://docs.microsoft.com/microsoft-365/commerce/buy-another-subscription?view=o365-worldwide).
