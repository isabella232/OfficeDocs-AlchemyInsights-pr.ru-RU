...
1. Нажмите кнопку [Далее](https://support.office.com/article/https://portal.office.com/adminportal/home.aspx#/Contact) для перехода к странице Изменить контакт в портал администрирования. 
...
1. Нажмите кнопку [Далее](https://support.office.com/article/https://portal.office.com/adminportal/home.aspx#/groups) для перехода к странице группы. 
