...
Чтобы узнать о параметрах без запуска миграции, ознакомьтесь со статьей [Выбор пути миграции](https://docs.microsoft.com/en-us/Exchange/mailbox-migration/decide-on-a-migration-path).
