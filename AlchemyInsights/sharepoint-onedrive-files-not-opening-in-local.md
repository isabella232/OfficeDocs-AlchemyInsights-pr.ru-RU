...
**Note**: при возникновении проблем с открытием документов в браузере или клиенте по умолчанию может потребоваться изменить параметр библиотеки. Для этого перейдите к библиотеке с проблемами > значок шестеренки в правом верхнем углу > параметры библиотеки > дополнительные параметры > открытии документов в браузере.
