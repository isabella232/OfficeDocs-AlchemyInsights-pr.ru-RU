...
**Note**: при возникновении проблем с открытием документов в браузере или клиенте по умолчанию может потребоваться изменить параметр библиотеки. Для этого перейдите в раздел поведение по умолчанию при открытии >по умолчанию для документов с поддержкой браузера.
