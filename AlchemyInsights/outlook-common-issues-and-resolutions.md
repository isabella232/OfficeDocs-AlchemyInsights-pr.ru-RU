...
- **Подключение:** При возникновении проблем с подключением запустите [Outlook, чтобы сказать: "попытка подключения...". или "отключенный"](https://aka.ms/SaRA-OutlookDisconnect) сценарий, или [Outlook запрашивает пароль](https://aka.ms/SaRA-OutlookPwdPrompt) от [помощника по поддержке и восстановлению Майкрософт для Office 365](https://diagnostics.outlook.com/#/).
...
- **Общий доступ к календарю:** В этой статье представлены рекомендации [по общему доступу к календарю в Office 365](https://support.office.com/article/b576ecc3-0945-4d75-85f1-5efafb8a37b4) и [календарях](https://support.office.com/article/D93F72D3-2361-4E0D-8D6A-5C4939C17F39).
