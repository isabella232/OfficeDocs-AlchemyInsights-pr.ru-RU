...
ms.locfileid: "53962216"
---
# <a name="import-contacts"></a>Импорт контактов

Перед импортом контактов на Outlook.com необходимо экспортировать их из другого поставщика электронной почты в .csv файл. Затем следуйте инструкциям ниже.
...
.
2. В верхней части страницы выберите Управление **контактами** \> **импорта.**
3. Выберите **Обзор,** перейдите в папку, в которой сохранены экспортные контакты, и **откройте**.

Дополнительные новости см. в [сайте Import contacts to Outlook.com.](https://support.office.com/article/285a3b55-8d93-4ac8-93df-43fffd13b2f1?wt.mc_id=Office_Outlook_com_Alchemy)
