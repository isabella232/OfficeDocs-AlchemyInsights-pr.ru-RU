...
2. Выберите подписку, которую необходимо повторно активировать. В разделе выставление счетов выберите пункт **Реактивизировать**.
    ...
    Если вы не видите функцию " **Повторная активация** " в качестве доступного действия, [обратитесь в службу поддержки](https://docs.microsoft.com/microsoft-365/admin/contact-support-for-business-products) , чтобы повторно активировать подписку.
