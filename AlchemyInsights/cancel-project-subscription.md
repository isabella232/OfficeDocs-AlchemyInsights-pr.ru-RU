...
ms.locfileid: "57900441"
---
# <a name="cancel-project-subscription"></a>Отмена Project подписки

Администраторы могут отменить подписку Project для своей организации в Центр администрирования Microsoft 365.

1. Перейдите на страницу **Выставление счетов** \> [Ваши продукты](https://go.microsoft.com/fwlink/p/?linkid=842054).
2. На **вкладке Продукты** найдите Project подписку, которую необходимо отменить. Щелкните три точки (другие действия) и выберите **Отменить подписку**.
