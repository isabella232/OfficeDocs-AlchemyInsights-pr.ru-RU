---
title: Тестирование inline изображений алхимии
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "53998345"
---
# <a name="access-the-domains-page"></a>Доступ к странице Домены

Чтобы получить доступ к странице доменов, щелкните этот значок ниже:
...
Затем можно добавить, изменить или удалить домен.
