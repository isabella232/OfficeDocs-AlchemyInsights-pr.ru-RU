...
ms.locfileid: "36507176"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="8ebad-102">Доступ к странице "домены"</span><span class="sxs-lookup"><span data-stu-id="8ebad-102">Access the Domains Page</span></span>

<span data-ttu-id="8ebad-103">Чтобы открыть страницу домены, просто щелкните следующий значок:</span><span class="sxs-lookup"><span data-stu-id="8ebad-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="8ebad-104">После этого вы можете добавить, изменить или удалить домен.</span><span class="sxs-lookup"><span data-stu-id="8ebad-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="8ebad-105">Дополнительные сведения приведены в статье [вопросы и ответы по доменам.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="8ebad-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
