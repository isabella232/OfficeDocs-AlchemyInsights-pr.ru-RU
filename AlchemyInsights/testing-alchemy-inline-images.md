...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="dc1b5-102">Доступ к странице "домены"</span><span class="sxs-lookup"><span data-stu-id="dc1b5-102">Access the Domains Page</span></span>

<span data-ttu-id="dc1b5-103">Чтобы открыть страницу домены, просто щелкните следующий значок:</span><span class="sxs-lookup"><span data-stu-id="dc1b5-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="dc1b5-104">После этого вы можете добавить, изменить или удалить домен.</span><span class="sxs-lookup"><span data-stu-id="dc1b5-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="dc1b5-105">Дополнительные сведения приведены в статье [вопросы и ответы по доменам.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="dc1b5-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
