...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="85c19-102">Доступ к странице "домены"</span><span class="sxs-lookup"><span data-stu-id="85c19-102">Access the Domains Page</span></span>

<span data-ttu-id="85c19-103">Чтобы открыть страницу домены, просто щелкните следующий значок:</span><span class="sxs-lookup"><span data-stu-id="85c19-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="85c19-104">После этого вы можете добавить, изменить или удалить домен.</span><span class="sxs-lookup"><span data-stu-id="85c19-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="85c19-105">Дополнительные сведения приведены в статье [вопросы и ответы по доменам.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="85c19-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
