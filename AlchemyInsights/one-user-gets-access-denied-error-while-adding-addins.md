...
---
# <a name="one-user-gets-access-denied-error-while-adding-add-ins-in-outlook"></a>Ошибка "Отказано в доступе" для одного пользователя при добавлении надстроек в Outlook

Пользователю PowerShell необходимо найти следующие разрешения:
