 ...
 **Примечание**: Если при попытке входа в [https://todo.microsoft.com](https://todo.microsoft.com)систему появляется сообщение об ошибке 501 [https://to-do.microsoft.com](https://to-do.microsoft.com), попробуйте.
