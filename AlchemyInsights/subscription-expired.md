...
2. На вкладке **Продукты** найдите подписку, которую хотите повторно активировать, выберите пункт **Другие действия** (три точки), а затем нажмите **Повторно активировать эту подписку**.
    > [!NOTE]
