...
ms.locfileid: "32421181"
---
# <a name="solutions-for-error-30016-4"></a>Решения для ошибки 30016-4


При попытке удалить Office 365 профессиональный плюс с компьютера появляется сообщение об ошибке, **что-то пошло**не так 30016-4, это означает, что диск **% TEMP%** сопоставлен с диском, отличным от **% ProgramFiles%**.
  
Чтобы исправить, скачайте и установите [Помощник по поддержке и восстановлению](https://aka.ms/SARA-OfficeUninstall-Alchemy)
