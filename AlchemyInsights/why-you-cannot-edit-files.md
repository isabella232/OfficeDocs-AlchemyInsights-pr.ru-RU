...
---
# <a name="why-cant-i-edit-files"></a>Почему не удается редактировать файлы?

Пройдите краткий обзор некоторых причин, по [которым вы, возможно, не сможете редактировать файл](https://support.office.com/article/why-can-t-i-edit-this-file-97315f48-aa5e-49d3-a4ae-a14b73daf87b).

Если у вас есть библиотеки с **извлечением, обязательными** или **проверочными** столбцами или метаданными, или если для свойства **"безопасность элемента черновиков"** заданы **только пользователи, которые** могут **утверждать элементы** в параметрах версий библиотеки:
...
- [Ошибка "не удалось отправить" или "не удается сохранить автоматически" при редактировании файла Office](https://support.office.com/article/i-got-an-upload-failed-or-couldn-t-save-automatically-error-while-editing-an-office-file-93a14d34-88e3-4a91-9eef-58cc541d31f8)
