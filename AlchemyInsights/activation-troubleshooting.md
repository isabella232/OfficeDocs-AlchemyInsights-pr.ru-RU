...
В **Control Panel** окне \> **программы и компоненты**панели управления выполните поиск в Office. Вы должны увидеть приложения Microsoft 365 для предприятий или Майкрософт 365 для бизнеса. Если отображается несколько версий Office, удалите неиспользуемые.
