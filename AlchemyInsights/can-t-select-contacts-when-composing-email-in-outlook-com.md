...
При создании нового сообщения электронной почты и нажатии кнопок **"Кому" или "копия"** некоторые пользователи могут не видеть свой список контактов. **** Чтобы выбрать имена, начните вводить текст в полях **Кому** или **копия** , а также будут отображены соответствующие контакты. 
