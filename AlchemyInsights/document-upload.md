...
> [!NOTE]
>  Можно загружать файлы размером до 15 ГБ. > Полный путь для файла (включая имя файла) не может быть более 400 символов в длину. > Если вам нужно передавать файлы более 100, [Используйте клиента синхронизации OneDrive](https://go.microsoft.com/fwlink/?linkid=866427). 
