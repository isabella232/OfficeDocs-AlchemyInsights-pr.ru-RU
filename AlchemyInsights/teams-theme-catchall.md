...
---
# <a name="new-to-microsoft-teams"></a>Новичкам в Microsoft Teams

Прочтите статью  [Начало работы с Microsoft Teams](https://docs.microsoft.com/microsoftteams/get-started-with-teams-quick-start). Не забудьте ознакомиться с учебными видеороликами для ИТ-администраторов Microsoft Teams, презентациями и другими материалами.
