...
ms.locfileid: "29500619"
---
# <a name="use-sara-to-diagnose-and-resolve-outlook-authentication-issues"></a>Используйте пользователя Валентины для диагностики и устранения ошибок проверки подлинности Outlook
