...
---
# <a name="verify-your-domain-with-123-regcouk"></a>Проверка домена с помощью 123-reg.co.uk
...
Пошаговые инструкции по [созданию записей DNS на сайте 123-reg.co.uk для Microsoft 365](https://docs.microsoft.com/microsoft-365/admin/dns/create-dns-records-at-123-reg-co-uk) .