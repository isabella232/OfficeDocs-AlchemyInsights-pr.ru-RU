...
- Рабочие процессы SharePoint 2010, задержанные при запуске.
    ...
    Кроме того, если размер журнала рабочего процесса увеличился, можно очистить элементы или создать новый список журналов.
...
Хотите попробовать Микрсофт Flow in SharePoint Online?
