...
ms.locfileid: "30244378"
---
# <a name="set-up-email-in-the-outlook-mobile-app"></a>Настройка электронной почты в мобильном приложении Outlook

1. Выберите пункт **начать работу** , если вы впервые настраиваете электронную почту в мобильном приложении. в противном случае нажмите кнопку **меню** , а затем выберите **Параметры** \> **Добавить учетную** \> запись **электронной почты**. 
