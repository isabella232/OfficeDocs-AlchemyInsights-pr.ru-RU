...
ms.locfileid: "51815412"
---
# <a name="enable-seamless-sso"></a>Включить бесшовную SSO

Azure Active Directory (Azure AD) Бесшовный единый Sign-On (Seamless SSO) автоматически подписывает у пользователей, когда они находятся на своих корпоративных рабочих столах, подключенных к корпоративной сети.
