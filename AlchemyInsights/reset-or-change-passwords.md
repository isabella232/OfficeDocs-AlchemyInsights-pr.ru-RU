...
[Щелкните здесь, чтобы узнать больше](https://docs.microsoft.com/microsoft-365/admin/add-users/reset-passwords), или, чтобы пользователи могли сбросить свои забытые пароли.
