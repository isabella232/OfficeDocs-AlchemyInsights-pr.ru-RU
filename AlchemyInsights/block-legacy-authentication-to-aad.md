...
- [Блокировка доступа при обнаружении риска сеанса с помощью условного доступа Azure Active Directory](https://docs.microsoft.com/azure/active-directory/conditional-access/app-sign-in-risk)