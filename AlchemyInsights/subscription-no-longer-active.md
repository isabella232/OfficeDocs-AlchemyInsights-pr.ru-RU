...
ms.locfileid: "53687403"
---
# <a name="subscription-no-longer-active"></a>Подписка больше неактивна

Если при открытии приложения Microsoft 365 [появляется уведомление о подписке](https://support.microsoft.com/office/a-subscription-notice-appears-when-i-open-a-microsoft-365-application-4cabe32c-f594-4c0e-9191-3d3ade10cceb), скорее всего, вам требуется повторно активировать свою подписку.
