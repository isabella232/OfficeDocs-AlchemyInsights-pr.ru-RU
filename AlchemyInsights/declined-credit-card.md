...
ms.locfileid: "48416653"
---
# <a name="declined-credit-card"></a>Отклоненная кредитная карта

Если вы используете кредитную карту, но платеж не прошел, вы получите по электронной почте сообщение о том, что нам не удалось обработать платеж. Дважды убедитесь, что [сведения о кредитной карте](https://go.microsoft.com/fwlink/p/?linkid=842054) (номер карты, Дата окончания срока действия, имя на кредитной карте и адрес, включая город, штат и почтовый индекс) отображаются точно так же, как на кредитной карте и в выписки по кредитной карте. Вы можете обновить сведения о кредитных картах и сразу отправите платеж с помощью параметра **сопоставление сальдо** на странице **выставление**  >  [продукции](https://go.microsoft.com/fwlink/p/?linkid=842054) .

Чтобы узнать больше, ознакомьтесь со статьей "что делать, если у моей кредитной карты истек срок действия и дата платежа просрочена?". [Оплата подписки на Microsoft 365 для бизнеса](https://docs.microsoft.com/microsoft-365/commerce/billing-and-payments/pay-for-your-subscription#what-if-my-credit-card-was-declined-and-my-payment-is-past-due).
